module github.com/huoxue1/fan

go 1.17

require (
	github.com/go-sql-driver/mysql v1.6.0
	github.com/huoxue1/gg v1.3.0
	github.com/huoxue1/leafbot v1.1.9-0.20220227052021-1eb32a6c159c
...
require (
	...
	github.com/Mrs4s/go-cqhttp v1.0.0-beta8-fix2 // indirect
